...
namespace BookMyHomeWebApp.Migrations
{
    ...
    [Migration("20250306102005_initialCreateBenjamin")]
    partial class initialCreateBenjamin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookMyHome.Shared.Domain.Models.Adresse", b =>
                {
            ...
            modelBuilder.Entity("BookMyHome.Shared.Domain.Models.Anmeldelse", b =>
                {
            ...
            modelBuilder.Entity("BookMyHome.Shared.Domain.Models.Bolig", b =>
                {
                    b.Property<int>("BoligID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookMyHome.Shared.Domain.Models.Booking", b =>
                {
            ...
            modelBuilder.Entity("BookMyHome.Shared.Domain.Models.Bruger", b =>
                {
                    b.Property<int>("BrugerID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookMyHome.Shared.Domain.Models.PostnummerOgBy", b =>
                {
                    b.Property<int>("Postnummer")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookMyHome.Shared.Domain.Models.Adresse", b =>
                {
                    b.HasOne("BookMyHome.Shared.Domain.Models.PostnummerOgBy", "PostnummerOgBy")
                        .WithMany()
            ...
            modelBuilder.Entity("BookMyHome.Shared.Domain.Models.Anmeldelse", b =>
                {
                    b.HasOne("BookMyHome.Shared.Domain.Models.Bolig", "bolig")
                        .WithMany("AnmeldelseList")
                        .HasForeignKey("BoligID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookMyHome.Shared.Domain.Models.Bruger", "bruger")
                        .WithMany()
            ...
            modelBuilder.Entity("BookMyHome.Shared.Domain.Models.Bolig", b =>
                {
                    b.HasOne("BookMyHome.Shared.Domain.Models.Adresse", "Adresse")
                        .WithMany()
